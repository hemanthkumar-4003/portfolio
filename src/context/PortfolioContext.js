  ...
  experience: [
    {
      ...
      company: "APCFSS",
      points: [
        "Developed microservices and RESTful APIs using Spring Boot.",
        "Applied Spring JPA and Spring Security for data management and authentication.",
        "Implemented layered architecture (Controller, Service, DAO) following OOP principles and design patterns.",
        "Debugged and resolved issues using SLF4J.",
        "Designed and optimized databases with constraints (CHECK, NOT NULL, UNIQUE) and wrote complex SQL queries (JOINs, Subqueries).",
